...
- **Domain:** SUI Blockchain Wallet Management.
- **Key Library:** `@mysten/sui` (v2.0+).
- **Standards:** BIP-44 (m/44'/784').
- **Architecture:** Extends base wallet classes to support SUI transactions, Coins, and fee estimation.
